...
from entities.reserva import EstadoReserva, Reserva
...
class ReservaCRUD:
    ...
    def crear_reserva(
        ...
        Args:
            ...
            id_usuario_creacion: UUID del usuario que registra la operación (auditoría)
        ...
        from entities.material_biblioteca import MaterialBiblioteca
    ...
    def obtener_reservas_por_usuario(self, id_usuario: UUID) -> List[Reserva]:
        """
    ...
    def obtener_reservas_por_material(self, id_material: UUID) -> List[Reserva]:
        """
        ...
        """
        return self.db.query(Reserva).filter(Reserva.id_material == id_material).all()

    def obtener_reservas_por_estado(self, estado: EstadoReserva) -> List[Reserva]:
        """
        ...
        """
        return self.db.query(Reserva).filter(Reserva.estado_reserva == estado).all()
    ...
    def actualizar_reserva(
        ...
        if "estado_reserva" in kwargs:
            if not isinstance(kwargs["estado_reserva"], EstadoReserva):
