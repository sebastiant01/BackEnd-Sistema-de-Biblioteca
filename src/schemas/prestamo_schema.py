...
class PrestamoCreate(BaseModel):
    """Schema para registrar un nuevo préstamo. Solo requiere IDs de entidades existentes."""
...
class PrestamoUpdate(BaseModel):
    """Schema para actualizar el estado de un préstamo (Ej: 'Activo' -> 'Devuelto')."""

    estado: Optional[str] = None


class PrestamoRead(BaseModel):
    """Schema para retornar los datos del préstamo. Convierte los tipos de SQLAlchemy a JSON."""
