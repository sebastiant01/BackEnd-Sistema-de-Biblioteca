...
class AutorCreate(BaseModel):
    """Schema para la creación de un nuevo autor."""
...
class AutorUpdate(BaseModel):
    """Schema para la actualización parcial de un autor. Todos los campos son opcionales."""
...
class AutorRead(BaseModel):
    """Schema para retornar los datos del autor al frontend."""
