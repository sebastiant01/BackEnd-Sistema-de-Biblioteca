...
class UsuarioCreate(BaseModel):
    """Schema para la creación de un nuevo usuario. Contiene solo los campos obligatorios."""
...
class UsuarioUpdate(BaseModel):
    """Schema para la actualización parcial de un usuario. Todos los campos son opcionales."""
...
class UsuarioRead(BaseModel):
    """Schema para retornar los datos del usuario al frontend.
    model_config = ConfigDict(from_attributes=True) permite que Pydantic lea el objeto de SQLAlchemy.
    """
